...
public class License {
    ...
    private static final InAppBilling[] PREMIUM_REQUEST_PRODUCTS = new InAppBilling[] {
            new InAppBilling("3_premium_requests", 3),
            new InAppBilling("5_premium_requests", 5),
            new InAppBilling("10_premium_requests", 10)
    };
    ...
    private static final InAppBilling[] DONATION_PRODUCT = new InAppBilling[] {
            new InAppBilling("soda"),
            new InAppBilling("kitkat"),
            new InAppBilling("pizza"),
            new InAppBilling("phone")
    };
